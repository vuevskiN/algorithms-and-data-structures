...
public class PrvKolokvium2020PrvTermin {
	...
	//od najgolem kon najmal
	public static DLL<Integer> srediSiGiListite(DLL<Integer> firstList, DLL<Integer> secondList)
	{
		DLL<Integer> resultList = new DLL<Integer>();
		...
		while(first != null && second != null)
		{
			...
			{
				resultList.insertLast(second.element);
				second = second.succ;
			}
		}
		...
		if(first == null)
		{
			...
			{
				if(second.element < second.succ.element)
				{
					resultList.insertLast(second.element);
				}
				...
				{
					resultList.insertLast(second.succ.element);
				}
				second = second.succ;
			}
		...
		else if(second ==  null)
		{
			...
			{
				if(first.element < first.succ.element)
				{
					resultList.insertLast(first.element);
				}
				...
				{
					resultList.insertLast(first.succ.element);
				}
				first = first.succ;
			}
